...
int Jumlah_Rarity_Karakter_Arknights(Karakter_Arknights arknights[], int jumlah_karakter_arknights, string rarity_cari) {
    int jumlah_rarity = 0;
...
bool Duplikat_Karakter_Arknights(Karakter_Arknights arknights[], int jumlah_karakter_arknights, string nama) {
    for (int i = 0; i < jumlah_karakter_arknights; ++i) {
...
void Menampilkan_Karakter_Arknights_Berdasarkan_Rarity(Karakter_Arknights arknights[], int jumlah_karakter_arknights, string rarity) {
...
void Menampilkan_Karakter_Arknights(Karakter_Arknights arknights[], int jumlah_karakter_arknights) {
    int choice;
...
void Tambah_Karakter_Arknights(Karakter_Arknights arknights[], int& jumlah_karakter_arknights) {
...
void Ubah_Karakter_Arknights(Karakter_Arknights arknights[], int jumlah_karakter_arknights) {
    if (jumlah_karakter_arknights == 0) {
        cout << "Tidak ada karakter Arknights yang tersedia." << endl;
    } else {
        int nomor;
...
void Hapus_Karakter_Arknights(Karakter_Arknights arknights[], int& jumlah_karakter_arknights) {
    if (jumlah_karakter_arknights == 0) {
        cout << "Tidak ada karakter Arknights yang tersedia." << endl;
    } else {
        int nomor;
...
void MenuUtama(Karakter_Arknights arknights[], int& jumlah_karakter_arknights) {
    int choice;
